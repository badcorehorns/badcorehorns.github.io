...
$('.js-3').attr('src', (dpi>1) ? 'images/rings-black-1050.png' : 'images/rings-black-525.png');
$('.js-4').attr('src', (dpi>1) ? 'images/bch-sec-text-1468.png' : 'images/bch-sec-text-734.png');
$('.js-5').attr('src', (dpi>1) ? 'images/rings-black-1050.png' : 'images/rings-black-525.png');
$('.js-6').attr('src', (dpi>1) ? 'images/bch-sec-text-1468.png' : 'images/bch-sec-text-734.png');
$('.js-7').attr('src', (dpi>1) ? 'images/bch-dnb-text-1468.png' : 'images/bch-dnb-text-734.png');
$('.js-8').attr('src', (dpi>1) ? 'images/bch-dnb-text-1468.png' : 'images/bch-dnb-text-734.png');
$('.js-9').attr('src', (dpi>1) ? 'images/bch-dnb-text-1468.png' : 'images/bch-dnb-text-734.png');
$('.js-10').attr('src', (dpi>1) ? 'images/rings-white-1050.png' : 'images/rings-white-525.png');
$('.js-11').attr('src', (dpi>1) ? 'images/rings-white-1050.png' : 'images/rings-white-525.png');
$('.js-12').attr('src', (dpi>1) ? 'images/rings-white-1050.png' : 'images/rings-white-525.png');}else{$('.js').attr('src', (dpi>1) ? 'images/rings-black-200.png' : 'images/rings-black-100.png');
$('.js-2').attr('src', (dpi>1) ? 'images/bch-sec-text-200.png' : 'images/bch-sec-text-100.png');
$('.js-3').attr('src', (dpi>1) ? 'images/rings-black-200.png' : 'images/rings-black-100.png');
$('.js-4').attr('src', (dpi>1) ? 'images/bch-sec-text-200.png' : 'images/bch-sec-text-100.png');
...
$('.js-9').attr('src', (dpi>1) ? 'images/bch-dnb-text-200.png' : 'images/bch-dnb-text-100.png');
$('.js-10').attr('src', (dpi>1) ? 'images/rings-white-200.png' : 'images/rings-white-100.png');
$('.js-11').attr('src', (dpi>1) ? 'images/rings-white-200.png' : 'images/rings-white-100.png');
